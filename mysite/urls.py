...
urlpatterns = [
    ...
    path('lycee/cursuscall/<int:cursus_id>', views.detailcursuscall,name="detailcursuscall"),
    ...
    path('lycee/call/all', views.indexcalllist,name = "indexcalllist"),
    ...
    path('lycee/call/<int:cursus_id>', views.detail_cursus_call,name = "detail_cursus_call"),
]